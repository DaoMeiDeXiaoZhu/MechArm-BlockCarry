...
All the environments are registered in the `first_rl` extension. They start
...
import first_rl.tasks  # noqa: F401


def main():
    """Print all environments registered in `first_rl` extension."""
